                ...
                <div class="form-base bg-modal-gray">
                    ...
                    <form action="./controller/subject-unit-registration.controller.php" method="post">
                        <p class="normal-14-medium-p name">
                            ...
                            <input type="text" class="input-text normal-12-regular-tinyinput input-name-module" placeholder="Digite o nome da matéria" name="name" id="name" required autofocus autocomplete="off" autofocus pattern="[A-Za-záàâãéèêíïóôõöúçñÁÀÂÃÉÈÍÏÓÔÕÖÚÇÑ ]+$" minlength="5">
                        </p>
