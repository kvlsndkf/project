                ...
                <a href="./list-module.page.php">
                    ...
                    <form action="./controller/module-unit-registration.controller.php" method="post">
                        <p class="normal-14-medium-p name">
                            Nome
                            <input class="input-text normal-12-regular-tinyinput input-name-module" type="text" name="name" id="name" placeholder="Digite o nome do módulo" required autocomplete="off" autofocus minlength="2">
                        </p>
                        <p>
