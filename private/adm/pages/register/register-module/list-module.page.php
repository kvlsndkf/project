                    ...
                    ?>
                        <div class="div-pagination">
                            <ul class="pagination">
                                ...
                                if ($prev_page != 0) { ?>
                                    <li class="page-item">
                                        <a class="page-link pagination-last normal-14-medium-p" href="./list-module.page.php?page=<?php echo $prev_page; ?> &searchModule=<?php echo $search; ?>" tabindex="-1" aria-disabled="true">Anterior</a>
                                    </li>
                                <?php    } else { ?>
                                    <li class="page-item disabled">
                                        <a class="page-link disable page-link disable pagination-last normal-14-medium-p" href="#" tabindex="-1" aria-disabled="true">Anterior</a>
                                    </li>
                                <?php }  ?>
                                ...
                                //Apresentar a paginação
                                for ($i = 1; $i < $page_qnt + 1; $i++) { ?>
                                    <li class="page-item"><a class="page-link pagination-page normal-14-medium-p" href="./list-module.page.php?page=<?php echo $i; ?> &searchModule=<?php echo $search; ?>"><?php echo $i; ?></a></li>
                                <?php }
                                ?>
                                ...
                                if ($next_page <= $page_qnt) { ?>
                                    <li class="page-item">
                                        <a class="page-link pagination-next normal-14-medium-p" href="./list-module.page.php?page=<?php echo $next_page; ?> &searchModule=<?php echo $search; ?>" tabindex="-1" aria-disabled="true">Próximo</a>
                                    </li>
                                <?php    } else { ?>
                                    <li class="page-item disabled">
                                        <a class="page-link disable pagination-next normal-14-medium-p" href="#" tabindex="-1" aria-disabled="true">Próximo</a>
