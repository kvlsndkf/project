...
<div class="modal-dialog">
    <div class="modal-content teste">
      <div class="modal-body body-modal">
        <div class="start">
          <span class="modal-title normal-20-bold-modaltitle white-title" id="exampleModalLabel">Excluir pergunta</span>
          <button type="button" class="btn-close btn-close-white" data-bs-dismiss="modal" aria-label="Close"></button>
        </div>
        <div>
            <p class="normal-14-bold-p title">
              Tem certeza de que deseja excluir essa pergunta permanentemente?
            </p>
        </div>
        <div class="warning-container">
          <span class="warning-text normal-12-bold-tiny colortext1">Dica: </span><span class="normal-12-bold-tiny title"> As perguntas só podem ser apagadas enquanto não houverem respostas.</span>
        </div>
