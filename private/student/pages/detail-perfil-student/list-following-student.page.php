                    ...
                    <?php for ($i = 0; $i < count($listFollowing); $i++) {
                        ...
                        <div class="question-footer following-profile" style="margin-bottom: 30px; margin-top: 30px; flex-wrap: wrap;">
                            ...
                            <div class="<?php echo $displayFollow; ?> following-profile stop-following" style="margin-top: 15px;">
                                <form class="stop-following" action="./controller/list-following.controller.php?idfollower=<?php echo $idUser; ?>&idFollowing=<?php echo $row->userId; ?>&idPerfil=<?php echo $idFollower; ?>" method="post">
