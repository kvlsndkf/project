...
--
-- Host: 127.0.0.1
-- Tempo de geração: 29-Jun-2022 às 19:17
...
(3, 'Material de Apoio', '2022-05-31 14:45:20', NULL);
...
--
-- Estrutura da tabela `denunciationshascontexts`
--
...
--
-- Extraindo dados da tabela `denunciationshascontexts`
--
...
CREATE TABLE `users` (
  ...
  `is_blocked` tinyint(1) NOT NULL,
  `blocking_reason` varchar(100) NOT NULL,
  `github` text DEFAULT NULL,
  `linkedin` text DEFAULT NULL,
  `facebook` text DEFAULT NULL,
  `instagram` text DEFAULT NULL,
...
INSERT INTO `users` (`id`, `email`, `password`, `photo`, `type_user`, `is_confirmed`, `key_confirm`, `is_blocked`, `blocking_reason`, `github`, `linkedin`, `facebook`, `instagram`, `profile_link`, `denunciation_id`, `created_at`, `updated_at`, `blocked_at`) VALUES
...
--
-- Estrutura da tabela `usershasfollowers`
--
...
--
-- Índices para tabela `denunciationshascontexts`
--
...
--
-- Índices para tabela `usershasfollowers`
--
...
ALTER TABLE `denunciations`
  ...
  ADD CONSTRAINT `denunciations_ibfk_5` FOREIGN KEY (`context_id`) REFERENCES `denunciationshascontexts` (`id`) ON DELETE CASCADE;
...
--
-- Limitadores para a tabela `usershasfollowers`
--
ALTER TABLE `usershasfollowers`
  ADD CONSTRAINT `usershasfollowers_ibfk_1` FOREIGN KEY (`follower_id`) REFERENCES `users` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `usershasfollowers_ibfk_2` FOREIGN KEY (`following_id`) REFERENCES `users` (`id`) ON DELETE CASCADE;
