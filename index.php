...
<head>
    ...
    <link rel="stylesheet" href="./views/landing-page/landing-page-styles.css">
    ...
    <!-- Títilo e Ícone -->
    <title>Heelp!</title>
    <link rel="icon" href="./views/landing-page/img/Logo-Blue.svg" type="image/icon type">
...
<body class="bode">
    ...
    <div class="bg">
                ...
                <div class="container">
                    <div class="content-navbar">
                        ...
                        <a href="#" class="a-class logo-heelp">
                            <img src="./views/landing-page/img/Logo-Transparente.svg" class="logo-img" alt="Logo Heelp!">
                        ...
                        <ul class="nav-list2">
                            <li>
                                <a href="./views/pages/login/login-page.php" class="a-class nav-options normal-14-bold-p white">Entrar</a>
                            </li>
                            <li>
                                <a href="./views/pages/register/register-profile/register-profile.pages.php" class="a-class nav-options normal-14-bold-p gray1">
            ...
            <div id="tela2">
                ...
                <div class="row">
                    <div class="col-md">
                        ...
                        <img src="./views/landing-page/img/foto1-ajuda.svg" class="img1">
        ...
        <div id="tela3">
            <div class="linha">
                <img src="./views/landing-page/img/foto2-networking.svg" class="img2">
                <div class="col">
        ...
        <div class="container">
            ...
            <div id="tela4">
                ...
                <div class="row g-0 row-tela4">
                    ...
                    <div class="col coln3">
                        <img src="./views/landing-page/img/perfil.svg" class="img4">
                    </div>
        ...
        <div id="tela5">
            ...
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col">
                        <img src="./views/landing-page/img/foto5-seta-circulo.svg" class="img5">
                    </div>

                    <div class="col">
                        <img src="./views/landing-page/img/foto6-ranking.svg" class="img6">
                    </div>
        ...
        <div class="container" id="vid">
            <div class="tela8">
                <div class="row-0">
                    ...
                    <div class="videoP">
                        <iframe width="560" height="315" src="https://www.youtube.com/embed/pLp3B8M251s" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                    </div>
                </div>
        ...
        <div id="tela6">
            ...
            <a href="./views/pages/register/register-profile/register-profile.pages.php" class="heelp-peca-btn normal-14-bold-p gray1">
                <div class="cadastrar-btn">
                    Cadastre-se
                </div>
            </a>
        ...
        <div id="tela7">
            ...
            <div class="div-da-seta">
                <a href="#tela1" class="seta-anchor">
                    <img src="./views/landing-page/img/botão âncora.svg" class="seta-img">
                </a>
            </div>
